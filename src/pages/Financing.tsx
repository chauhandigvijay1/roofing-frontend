  ...
  return (
    <section className="pt-36 pb-24 px-6 bg-white min-h-screen">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <p className="text-amber-600 text-sm font-semibold tracking-widest uppercase mb-3">Financing</p>
          <h1 className="text-4xl md:text-5xl font-bold text-zinc-900">Flexible Financing Options</h1>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {plans.map((p) => (
            <motion.div
              ...
              className="bg-stone-50 rounded-sm p-8 border border-stone-200 text-center hover:shadow-xl hover:shadow-stone-200/50 transition-shadow"
            >
              <div className="w-14 h-14 rounded-sm bg-amber-600/10 flex items-center justify-center mx-auto mb-5">
                <p.icon className="w-7 h-7 text-amber-600" />
              </div>
              <h3 className="text-lg font-bold text-zinc-900 mb-3">{p.title}</h3>
              <p className="text-zinc-600 text-sm">{p.desc}</p>
            </motion.div>
          ))}
        </div>
        ...
        <motion.div
          ...
          className="bg-amber-600/5 rounded-sm p-8 border border-amber-200"
        >
          <h3 className="text-xl font-bold text-zinc-900 mb-4">Easy Approval Process</h3>
